...
const authMiddleware = new ApolloLink((operation: Operation, foward: any) => {
...
const httpLink = new HttpLink({
  uri: isDev
    ...
    : "https://vast-retreat-63840.herokuapp.com/graphql"
});
...
const wsLink = new WebSocketLink({
  ...
  uri: isDev
    ...
    : "wss://vast-retreat-63840.herokuapp.com/subscription"
});
