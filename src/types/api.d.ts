...
export interface getDrivers_GetNearbyDrivers {
  __typename: "GetNearbyDriversResopnse";
  ok: boolean;
...
// ====================================================
// GraphQL subscription operation: rideUpdats
// ====================================================

export interface rideUpdats_RideStatusSubscription_driver {
  __typename: "User";
  id: number;
  fullName: string | null;
  profilePhoto: string | null;
...
export interface rideUpdats_RideStatusSubscription_passenger {
  __typename: "User";
  id: number;
  fullName: string | null;
  profilePhoto: string | null;
...
export interface rideUpdats_RideStatusSubscription {
  __typename: "Ride";
  id: number;
  status: string;
  pickUpAddress: string;
  ...
  distance: string;
  duration: string;
  driver: rideUpdats_RideStatusSubscription_driver | null;
  passenger: rideUpdats_RideStatusSubscription_passenger;
  chatId: number | null;
}

export interface rideUpdats {
  RideStatusSubscription: rideUpdats_RideStatusSubscription | null;
}
